...
class IncomeForm extends Form {
    ...
    doSubmit = () => {        
        this.props.addIncome(this.state.data);
    }
    ...
    render() {
        ...
        return (
            <div className="row">
                ...
                <div className="col-6">
                    <h1 className="text-uppercase text-center m-2">Dodaj przychód</h1>
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <Select name="category" label="Kategorie" categories={categories} onChange={this.handleChange} errors={errors} />
